...
function ENT:OnPopulateEntityInfo(container)
	...
	name:SetImportant()
	name:SetText("Double or Nothing")
	name:SizeToContents()

	local descriptionText = "Jackpot: " .. comma_value(self:GetJackpot()) .. "€"
...
jackpotFrames[2] = function(ScrW, ScrH)
	draw.SimpleText(L("jackpotFrame2"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame2"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--This isnt a glitch
jackpotFrames[3] = function(ScrW, ScrH)
	draw.SimpleText(L("jackpotFrame3"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame3"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--I'v got something to tell you
jackpotFrames[4] = function(ScrW, ScrH)
	draw.SimpleText(L("jackpotFrame4"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame4"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)

	draw.SimpleText(L("jackpotFrame4variant"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame4variant"), "BDON_MEDIAM", ScrW/2, ScrH / 2 + 75, Color(255,255,255,255), 1, 0)
end

--Something important
jackpotFrames[5] = function(ScrW, ScrH, ent)
	draw.SimpleText(L("jackpotFrame5"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame5"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
end

--Congratulations player
jackpotFrames[6] = function(ScrW, ScrH, ent)
	draw.SimpleText(L("jackpotFrame6"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame6"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)
...
jackpotFrames[7] = function(ScrW, ScrH, ent)
	draw.SimpleText(L("jackpotFrame7"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame7"), "BDON_MEDIAM", ScrW/2, ScrH / 2, Color(255,255,255,255), 1, 0)

	draw.SimpleText(L("jackpotFrame7variant"), "BDON_MEDIAM", ScrW/2 + 5, ScrH / 2 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame7variant"), "BDON_MEDIAM", ScrW/2, ScrH / 2 + 75, Color(255,255,255,255), 1, 0)	
end
...
jackpotFrames[9] = function(ScrW, ScrH, ent)
	...
	draw.SimpleText(L("jackpotFrame9"), "BDON_LARGE", ScrW/2 + 5, 450 + 5 - 30, Color(60,60,60,255), 1, 0)
	draw.SimpleText(L("jackpotFrame9"), "BDON_LARGE", ScrW/2, 450 - 30, Color(255,255,255, 255), 1, 0)

	draw.SimpleText(comma_value(ent:GetJackpot()) .. "€", "BDON_LARGE", ScrW/2 + 5, 450 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText(comma_value(ent:GetJackpot()) .. "€", "BDON_LARGE", ScrW/2, 450 + 75, Color(255,255,255,255), 1, 0)
...
jackpotFrames[10] = function(ScrW, ScrH, ent)
	...
	draw.SimpleText(comma_value(prizeValue) .. "€", "BDON_LARGE", ScrW/2 + 5, 450 + 5 + 75, Color(60,60,60,255), 1, 0)
	draw.SimpleText(comma_value(prizeValue) .. "€", "BDON_LARGE", ScrW/2, 450 + 75, Color(255,255,255,255), 1, 0)
...
function ENT:DrawScreen(ScrW, ScrH)
	...
	if self:GetCashOutAmount() > 0 then
		...
		draw.SimpleText(L("dobCashout"), "BDON_LARGE", ScrW/2 + 5, 350 + 5 - 30, Color(60,60,60,255), 1, 0)
		draw.SimpleText(L("dobCashout"), "BDON_LARGE", ScrW/2, 350 - 30, Color(255,255,255,255), 1, 0)

		draw.SimpleText(comma_value(self:GetCashOutAmount()) .. "€", "BDON_LARGE", ScrW/2 + 5, 350 + 5 + 75, Color(60,60,60,255), 1, 0)
		draw.SimpleText(comma_value(self:GetCashOutAmount()) .. "€", "BDON_LARGE", ScrW/2, 350 + 75, Color(255,255,255,255), 1, 0)

		--Draw the current user 
		local textToDisplay = L("dobCurrentUser")..self:GetUserName()
	...
	if self:GetGameStarted() == false then
		...
		draw.SimpleText(comma_value(ix.config.Get("doubleOrNothingBet")).."€ " .. L("dobPerGame"), "BDON_LARGE", ScrW/2 + 5, 350 + 5, Color(60,60,60,255), 1, 0)
		draw.SimpleText(comma_value(ix.config.Get("doubleOrNothingBet")).."€ " .. L("dobPerGame"), "BDON_LARGE", ScrW/2, 350, Color(255,255,255,255), 1, 0)

		draw.SimpleText(L("dobJackpotText"), "BDON_MEDIAM", ScrW/2 + 5, ScrH - 450 + 5, Color(60,60,60,255), 1, 0)
		draw.SimpleText(L("dobJackpotText"), "BDON_MEDIAM", ScrW/2, ScrH - 450, Color(255,255,255,255), 1, 0)

		draw.SimpleText(comma_value(self:GetJackpot()) .. "€", "BDON_MEDIAM", ScrW/2 + 5, ScrH - 450 + 5 + 75, Color(60,60,60,255), 1, 0)
		draw.SimpleText(comma_value(self:GetJackpot()) .. "€", "BDON_MEDIAM", ScrW/2, ScrH - 450 + 75, Color(255,255,255,255), 1, 0)
	...
	local bet = ix.config.Get("doubleOrNothingBet")
	...
	draw.SimpleText(comma_value(bet) .. "€", "BDON_LARGE", ScrW/2 + 5, 350 + 5, Color(60,60,60,255), 1, 0)
	draw.SimpleText(comma_value(bet) .. "€", "BDON_LARGE", ScrW/2, 350, Color(255,255,255,255), 1, 0)
